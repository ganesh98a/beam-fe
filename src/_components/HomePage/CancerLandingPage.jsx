...
class CancerLandingPage extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
                        ...
                        <div class="container-fluid w-80 fullwidth">
                            <div class="row">
                                <div class="col-xl-10 col-lg-10 col-md-10 col-sm-12 col-12 text-center welcome-container mx-auto">
                                    <div className="welcome-kidney font-bold white-txt">Welcome to Beam Prostate Cancer</div>

                                    <div class="helping-physiotherap white-txt font-qbold col-12 mx-auto">Helping people living with prostate cancer to feel good through movement, education and wellbeing support.</div>
                    ...
                    <section>
                        <div class="container-fluid fullwidth">
                            <div className="col-lg-8 mx-auto">
                                <div class="row">
                                    <div className="w-30 col-lg-6 col-md-12 text-center"><p className="font-medium proud-text text-abbey ">Proudly in partnership with…</p></div>
                                    <div className="col-lg-6 col-md-12 align-self-center">
                                        <img src={constand.WEB_IMAGES + "logos/RM-logo.png"} />
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="icon-desc m-t-20 font-qmedium offer-text" >
                                        Here at Beam we aim to create a space that will support and inspire you. We develop sessions designed to improve your physical and emotional wellbeing. Our instructors are specialists working in or living with prostate cancer so you can be confident they'll understand your needs.
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 icon-img">
                                    ...
                                    <Link class="btn btn-purple m-t-30 p-t-10 p-b-10" to={'programs/prostate-cancer'}>Explore</Link>
                                ...
                                <div class="col-lg-4 col-md-4 icon-img">
                                    ...
                                    <Link class="btn btn-purple m-t-30 p-t-10 p-b-10" to={'liveClasses/prostate-cancer'}>Explore</Link>
                                ...
                                <div class="col-lg-4 col-md-4 icon-img">
                                    <div class="icon-img w-60 mx-auto"><img src={constand.WEB_IMAGES + "Character-pair.png"} /></div>
                        ...
                        <div class="container-fluid w-80 p-b-20 fullwidth">
                            <div class="row">
                                ...
                                <div class="section-content font-qmedium">
                                    We are currently piloting Beam Prostate Cancer and is currently <span className="font-bold">completely free for people living with prostate cancer, their clinicians and carers.</span>  This free offer is open until 30th April, 2021.
				                </div>
                            </div>
                            <div class="row">
                                ...
                                <div className="col-12 d-flex align-items-center  col-md-9 col-lg-8 text-left  p-b-30">
                                    <div className="card cardnew border-0 align-section">
                                        ...
                                        <div className="readnow">
                                            <Link class="btn btn-darkblue col-md-5 col-10 p-t-10 p-b-10 w-80" to={'blogs/safety-info-prostate-cancer'}>Read Now</Link></div>
                                    </div>
                                </div>
                    ...
                    <section class="">
                        <div class="container-fluid w-80 p-b-20 fullwidth">
                            <div class="row">
                                ...
                                <div class="section-content font-qmedium">
                                    Beam has been developed in collaboration with prostate cancer clinicians and charities. We strive to be a platform that you can trust and rely on and which will support you to care for your community. To understand more about Beam please head over to our <a href="/partnerships/prostate-cancer" className="purplefont"><u>partnerships page</u></a> - here you can also learn about opportunities to collaborate on research and content, and ways in which we can support you deliver remote care to your patients.
				                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-4 offset-lg-4 col-8 mx-auto text-center">
                                    <Link class="btn bluebtn w-100 m-t-30 m-b-30 p-t-10 p-b-10" to={'partnerships/prostate-cancer'}>Partner with us</Link>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-12 text-center">
                                    ...
                                    <div class="section-content text-left">
                                        <div className="col-lg-8 col-md-12 ml-auto mr-auto">
                                            <CommonForm location={this.props.location} from="cancer" />
                                        </div>
                                    </div>
                                </div>
                            </div>
