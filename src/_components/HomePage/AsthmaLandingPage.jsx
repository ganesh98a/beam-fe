...
class AsthmaLandingPage extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
                        ...
                        <div class="container-fluid w-80 fullwidth">
                            <div class="row">
                                <div class="col-xl-10 col-lg-10 col-md-10 col-sm-12 col-12 text-center welcome-container mx-auto">
                                    <div className="welcome-kidney font-bold white-txt">Welcome to Beam Asthma Kids</div>

                                    <div class="helping-physiotherap white-txt font-qbold col-12 mx-auto">Helping young people living with asthma to feel good through movement, education and wellbeing support.</div>
                            ...
                            <div className="col-lg-8 mx-auto">
                                <div class="row">
                                    ...
                                    <div className="col-lg-6 col-md-12 align-self-center">
                                        <img src={constand.WEB_IMAGES + "logos/RBHH-logo.jpg"} />
                        ...
                        <div class="container-fluid w-80 fullwidth">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    Here at Beam we aim to create a space that will support and inspire you. We develop sessions designed to improve your physical and emotional wellbeing. Our instructors are specialists working with young people who have asthma so you can be confident they'll understand your needs.
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4 icon-img mx-auto">
                                    ...
                                    <Link class="btn btn-purple m-t-30 p-t-10 p-b-10" to={'programs/asthma kids'}>Explore</Link>
                                ...
                                <div class="col-lg-4 col-md-4 icon-img mx-auto">
                                    ...
                                    <Link class="btn btn-purple m-t-30 p-t-10 p-b-10" to={'liveClasses/asthama kids'}>Explore</Link>
                    ...
                    <section class="">
                        <div class="container-fluid w-80 p-b-20 fullwidth">
                            <div class="row">
                                ...
                                We are currently piloting Beam Asthma Kids with a specific research group. If this is you and you have a research code please click below to sign up.
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div className="col-12 d-flex align-items-center  col-md-9 col-lg-8 text-left  p-b-30">
                                    <div className="card cardnew border-0 align-section">
                                        ...
                                        <div className="readnow">
                                            <Link class="btn btn-darkblue col-md-5 col-10 p-t-10 p-b-10 w-80" to={'blogs/safety-information-for-kids-with-asthma-on-beam'}>Read Now</Link></div>
                                    </div>
                                </div>
                    ...
                    <section class="">
                        <div class="container-fluid w-80 p-b-20 fullwidth">
                            <div class="row">
                                ...
                                <div class="section-content font-qmedium">
                                Beam has been developed in collaboration with asthma clinicians and charities. We strive to be a platform that you can trust and rely on and which will support you to care for your community. To understand more about Beam or to express an interest in working with us in future please click the button below and complete our contact form.
				                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-4 offset-lg-4 col-8 mx-auto text-center">
                                    <Link class="btn bluebtn w-100 m-t-30 m-b-30 p-t-10 p-b-10" to={'#contact-form'}>Contact us</Link>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-12 text-center">
                                    ...
                                    <div class="section-content text-left">
                                        <div className="col-lg-8 col-md-12 ml-auto mr-auto">
                                            <CommonForm location={this.props.location} from="asthma" />
                                        </div>
                                    </div>
                                </div>
                            </div>
